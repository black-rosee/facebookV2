...
### Logo
_logo_line_1_ = ('%s    ___       ____     ______   ______   ______   ___ '%(_H_))
_logo_line_2_ = ('%s   /   |     / __ \   / ____/  / ____/  / ____/  /   |'%(_H_))
_logo_line_3_ = ('%s  / /| |    / /_/ /  / / __   / __/    / /      / /| |'%(_H_))
_logo_line_4_ = ('%s / ___ |   / _, _/  / /_/ /  / /___   / /___   / ___ |'%(_H_))
_logo_line_5_ = ('%s/_/  |_|  /_/ |_|   \____/  /_____/   \____/  /_/  |_|'%(_H_))
_logo_line_6_ = ('%s©©©©©©https://github.com/black-rosee/black-rosee©©©©©©'%(_M_)) 
def _my_logo_():
