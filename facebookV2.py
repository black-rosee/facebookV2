...
_logo_line_2_ = ('%s   /   |     / __ \   / ____/  / ____/  / ____/  /   |'%(_M_))
_logo_line_3_ = ('%s  / /| |    / /_/ /  / / __   / __/    / /      / /| |'%(_M_))
_logo_line_4_ = ('%s / ___ |   / _, _/  / /_/ /  / /___   / /___   / ___ |'%(_M_))
_logo_line_5_ = ('%s/_/  |_|  /_/ |_|   \____/  /_____/   \____/  /_/  |_|'%(_M_))
_logo_line_6_ = ('%s ☆☆☆☆https://github.com/black-rosee☆☆☆☆ '%(_U_)) 
