...
_M_ = "\x1b[1;91m"         # MERAH
_H_ = "\x1b[1;92m"         # HIJAU
_K_ = "\x1b[1;93m"        # KUNING
_B_ = "\x1b[1;94m"          # BIRU
_U_ = "\x1b[1;95m"         # UNGU
_BM_ = "\x1b[1;96m"        # BIRU MUDA

### Logo
_logo_line_1_ = ('%s    ___       ____     ______   ______   ______   ___ '%(_M_))
_logo_line_2_ = ('%s   /   |     / __ \   / ____/  / ____/  / ____/  /   |'%(_H_))
_logo_line_3_ = ('%s  / /| |    / /_/ /  / / __   / __/    / /      / /| |'%(_K_))
_logo_line_4_ = ('%s / ___ |   / _, _/  / /_/ /  / /___   / /___   / ___ |'%(_B_))
_logo_line_5_ = ('%s/_/  |_|  /_/ |_|   \____/  /_____/   \____/  /_/  |_|'%(_U_))
_logo_line_6_ = ('%s============https://github.com/black-rosee============'%(_BM_)) 
def _my_logo_():
